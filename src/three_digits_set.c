...
/*   Updated: 2024/02/14 13:31:48 by tauer            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned long	get_min(t_element *first)
{
	...
	if ((first->sorted_index < first->next->sorted_index)
		&& (first->sorted_index < first->next->next->sorted_index))
		min = first->sorted_index;
	else if ((first->next->sorted_index < first->sorted_index)
		&& (first->next->sorted_index < first->next->next->sorted_index))
		min = first->next->sorted_index;
	else if ((first->next->next->sorted_index < first->sorted_index)
		&& (first->next->next->sorted_index < first->next->sorted_index))
...
unsigned long	get_medium(t_element *first)
{
	...
	else if ((first->sorted_index < first->next->sorted_index)
		&& (first->sorted_index > first->next->next->sorted_index))
		medium = first->sorted_index;
	else if ((first->next->sorted_index > first->sorted_index)
		&& (first->next->sorted_index < first->next->next->sorted_index))
